...
declare module "electron-builder/out/builder" {
  ...
  import { PublishConfiguration, GithubPublishConfiguration } from "electron-builder/out/options/publishOptions"
  ...
  export function createPublisher(packager: Packager, options: PublishOptions, publishConfig: PublishConfiguration | GithubPublishConfiguration, isPublishOptionGuessed?: boolean): Promise<Publisher | null>
}
...
declare module "electron-builder/out/metadata" {
  ...
  import { PublishConfiguration } from "electron-builder/out/options/publishOptions"
...
declare module "electron-builder/out/publish/gitHubPublisher" {
  import { PublishOptions, Publisher } from "electron-builder/out/publish/publisher"
  import { GithubPublishConfiguration } from "electron-builder/out/options/publishOptions"
  ...
  export class GitHubPublisher implements Publisher {
    ...
    constructor(owner: string, repo: string, version: string, options: PublishOptions, isPublishOptionGuessed?: boolean, config?: GithubPublishConfiguration | null)
